...
const Login = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className='h-screen bg-gradient-to-tr from-black to bg-cyan-500 flex flex-col gap-3 items-center justify-center '>
        ...
        <input onChange={handleChange} required name='email' placeholder='enter your email ' className='text-2xl focus:outline-sky-300  '/>
        <label className='text-white text-3xl'>Password</label>
        <input onChange={handleChange} required name='password' type='password' placeholder='enter password' className='text-2xl focus:outline-sky-300 '/>
